	...
	*/		
		...
		*/					let d = withoutPath( $3 || u1 );
		...
		//							hasImg = false; 							
					...
					// Tabellen umwandeln
					// head
					txt = txt.replace(/<table[^>]*> <tbody>/g,'<w:tbl><w:tblPr><w:tblStyle w:val="Tabellenraster"/><w:tblW w:w="0" w:type="auto"/><w:tblLook w:val="04A0" w:firstRow="1" w:lastRow="0" w:firstColumn="1" w:lastColumn="0" w:noHBand="0" w:noVBand="1"/></w:tblPr>');
					// Tabellenkopf
...
//	console.debug( 'oxml',file );
	...
	file.parts.push( packText(file.sections) );
...
//	console.debug('file',file);
	...
	function packRels( imgL ) {
		var ct = '<pkg:part pkg:name="/_rels/.rels" pkg:contentType="application/vnd.openxmlformats-package.relationships+xml" pkg:padding="512">'
		+		'<pkg:xmlData>'
